...
> **Состояние:** работает. Приложение с окном и значком в строке меню,
> консольная версия, автопоиск лент по Bonjour с проверкой приёма,
> шестнадцать языков интерфейса.
