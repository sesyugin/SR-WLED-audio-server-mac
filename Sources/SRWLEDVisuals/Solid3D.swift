...
struct Solid3D {
    ...
    struct Material {
        /// Тон в глубокой тени.
        ///
        /// Оба тона взяты с венца: столбики идут от 0.030 в тишине до 0.105
        /// на пике, и тела сцены держатся той же вилки. Прежние 0.055–0.115
        /// уводили их в жёлтое золото, и посреди раскалённого оранжевого
        /// венца группа выглядела вырезанной из другой картинки — латунные
        /// фигурки, вставленные в огонь.
        var deepHue: Double = 0.032
        /// Тон на свету.
        var liteHue: Double = 0.098
        ...
        ///
        /// И убавляется тем сильнее, чем тело глуше. Слои на просвет — про
        /// стекло: сквозь кабинет колонки и обечайку барабана свет не идёт,
        /// а слои шли в полную силу и складывались поверх заливки. Установка
        /// от этого вымывалась в один бежевый тон без светлой и тёмной
